...
public class IPodexTest {
    ...
    @Test
    public void testGetPokemonSuccess() throws PokedexException {
    ...
    @Test
    public void testGetPokemonFailure() throws PokedexException {
        IPokedex pokedex = mock(IPokedex.class);
    ...
    @Test
    public void givenInvalidIndexExceptionThrows() throws PokedexException {
        IPokedex pokedex = mock(IPokedex.class);
        int invalidIndex = -1;
    ...
    @Test
    public void testUnmodifiableGetPokemonsList() {
        IPokedex pokedex = mock(IPokedex.class);
    ...
    @Test
    public void testGetPokemonsSortedAndUnmodifiable() {
