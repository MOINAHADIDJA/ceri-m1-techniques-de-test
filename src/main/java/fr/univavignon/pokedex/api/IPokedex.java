...
public interface IPokedex extends IPokemonMetadataProvider, IPokemonFactory {
	...
	/**
	 * Adds the given <p>pokemon</p> to this pokedex and returns
	 * it unique index.
	 * 
	...
	/**
	 * Locates the pokemon identified by the given <p>id</p>.
	 * 
	...
	/**
	 * Returns an unmodifiable list of all pokemons this pokedex contains.
	 * The list view will be sorted using the given <p>order</p>.
	 * 
